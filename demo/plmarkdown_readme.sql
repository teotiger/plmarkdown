...
BEGIN
  ...
  l_md.p('**Notes:** Valid chart types are ''pie'', ''bar'', ''line'' and ''area'', valid image types ''png'' and ''svg''. For more information see [plmarkdown_hr_schema.md](https://github.com/teotiger/plmarkdown/blob/master/demo/plmarkdown_hr_schema.md) in the demo section or visit the website from [chartspree.io](http://chartspree.io).');

  l_md.h2('HTML Output');
  l_md.p('The markdown generated by PLMarkdown can be converted using a PL/SQL packge from [here](https://github.com/nvanbaren/Markdown-plsql).');
